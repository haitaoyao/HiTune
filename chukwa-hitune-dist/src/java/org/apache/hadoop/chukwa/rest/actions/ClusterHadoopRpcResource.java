...
import org.apache.hadoop.chukwa.rest.services.ClusterHadoopRpcHome;

@Path ("/cluster_hadoop_rpc")
@Produces("application/xml")
public class ClusterHadoopRpcResource extends RestController {
	...
	ClusterHadoopRpc model = ClusterHadoopRpcHome.find(timestamp);
	...
	ClusterHadoopRpc model = ClusterHadoopRpcHome.find(timestamp, host);
	return convertToXml(model);
    }
	...
	Collection<ClusterHadoopRpc> list = ClusterHadoopRpcHome.findBetween(starttime,endtime);
