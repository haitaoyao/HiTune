...
import org.apache.hadoop.chukwa.rest.services.DfsFsNameSystemHome;

@Path ("/dfs_fsnamesystem")
@Produces("application/xml")
public class DfsFsNameSystemResource extends RestController {
	...
	Collection<DfsFsNameSystem> list = DfsFsNameSystemHome.findBetween(starttime,endtime);
