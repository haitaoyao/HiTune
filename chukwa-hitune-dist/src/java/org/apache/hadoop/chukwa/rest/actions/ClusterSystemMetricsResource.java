...
import org.apache.hadoop.chukwa.rest.services.ClusterSystemMetricsHome;

@Path ("/cluster_system_metrics")
@Produces("application/xml")
public class ClusterSystemMetricsResource extends RestController {
	...
	Collection<ClusterSystemMetrics> list = ClusterSystemMetricsHome.findBetween(starttime,endtime);
