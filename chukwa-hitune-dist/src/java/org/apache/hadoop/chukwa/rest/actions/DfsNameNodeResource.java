...
import org.apache.hadoop.chukwa.rest.services.DfsNameNodeHome;

@Path ("/dfs_namenode")
@Produces("application/xml")
public class DfsNameNodeResource extends RestController {
	...
	Collection<DfsNameNode> list = DfsNameNodeHome.findBetween(starttime,endtime);
